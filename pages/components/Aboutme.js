        ...
        <section id="aboutme" className="bg-gray-900">
            <div className="grid max-w-screen-xl px-4 py-8 mx-auto lg:gap-8 xl:gap-0 lg:py-16 lg:grid-cols-12">
                <div className="mr-auto place-self-center lg:col-span-7">
                    ...
                    <button type="" href="#projects" className="rounded-lg text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br shadow-lg shadow-purple-500/50 font-medium text-sm px-5 py-2.5 text-center mr-2 mb-2">
                        My Projects
                    </button>
